...
from jeti.module_utils.six import PY3

from jeti.module_utils.basic import get_distribution
from jeti.module_utils._text import to_bytes, to_native, to_text
...
try:
    from jeti.module_utils.six.moves.urllib.parse import urlparse, urlunparse
    HAS_URLPARSE = True
except Exception:
    HAS_URLPARSE = False
