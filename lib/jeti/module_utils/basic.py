...
from jeti.module_utils.common.text.converters import (
    jsonify,
    container_to_bytes as json_dict_unicode_to_bytes,
    container_to_text as json_dict_bytes_to_unicode,
)

from jeti.module_utils.common.text.formatters import (
    lenient_lowercase,
    bytes_to_human,
    human_to_bytes,
    SIZE_RANGES,
...
try:
    from jeti.module_utils.common._json_compat import json
...
from jeti.module_utils.common._collections_compat import (
    KeysView,
    Mapping, MutableMapping,
    Sequence, MutableSequence,
    Set, MutableSet,
)
from jeti.module_utils.common.process import get_bin_path
from jeti.module_utils.common.file import (
...
from jeti.module_utils.common.sys_info import (
    get_distribution,
    get_distribution_version,
    get_platform_subclass,
)
from jeti.module_utils.pycompat24 import get_exception, literal_eval
from jeti.module_utils.common.parameters import (
    handle_aliases,
    list_deprecations,
    list_no_log_values,
    PASS_VARS,
...
from jeti.module_utils.six import (
    PY2,
    PY3,
    b,
    binary_type,
...
from jeti.module_utils.six.moves import map, reduce, shlex_quote
from jeti.module_utils.common.validation import (
...
from jeti.module_utils.common._utils import get_all_subclasses as _get_all_subclasses
from jeti.module_utils.parsing.convert_bool import BOOLEANS, BOOLEANS_FALSE, BOOLEANS_TRUE, boolean
...
class AnsibleModule(object):
    ...
    def run_command(self, args, check_rc=False, close_fds=True, executable=None, data=None, binary_data=False, path_prefix=None, cwd=None,
        ...
        #   /tmp/test_module_scratch/debug_dir/jeti/module_utils/basic.py
        # If using ansible or ansible-playbook with a remote system:
        #   /tmp/jeti_vmweLQ/jeti_modlib.zip/jeti/module_utils/basic.py

        # Clean out python paths set by ansiballz
        if 'PYTHONPATH' in os.environ:
            pypaths = os.environ['PYTHONPATH'].split(':')
            pypaths = [x for x in pypaths
                       if not x.endswith('/jeti_modlib.zip') and
