...
from jeti.module_utils.network.iosxr.utils.utils import get_interface_type
from jeti.module_utils.network.iosxr.argspec.l3_interfaces.l3_interfaces import L3_InterfacesArgs
