...
from jeti.module_utils.network.common.utils import dict_diff
from jeti.module_utils.six import iteritems
from jeti.module_utils.network.common.utils import remove_empties
from jeti.module_utils.network.iosxr. \
