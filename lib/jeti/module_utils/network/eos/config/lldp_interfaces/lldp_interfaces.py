...
from jeti.module_utils.network.common.utils import to_list, dict_diff, param_list_to_dict
from jeti.module_utils.network.eos.facts.facts import Facts
from jeti.module_utils.network.eos.utils.utils import normalize_interface
