...
from jeti.module_utils.network.junos.junos import get_param, tostring
from jeti.module_utils.network.junos.junos import get_configuration, get_capabilities
