...
from jeti.module_utils.network.fortios.argspec.system.system import SystemArgs
from jeti.module_utils.network.common.facts.facts import FactsBase
from jeti.module_utils.network.fortios.facts.system.system import SystemFacts
