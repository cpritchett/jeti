...
from jeti.module_utils.urls import generic_urlparse
from jeti.module_utils.urls import Request
...
from jeti.module_utils.six.moves.urllib.error import HTTPError
...
def upload_file(client, url, src, dest=None):
    ...
    Examples:
        ...
        >>> from jeti.module_utils.network.f5.icontrol import upload_client
