...
from jeti.module_utils.network.nxos.argspec.interfaces.interfaces import InterfacesArgs
from jeti.module_utils.network.nxos.utils.utils import get_interface_type
