...
from jeti.module_utils.network.nxos.argspec.lag_interfaces.lag_interfaces import Lag_interfacesArgs
from jeti.module_utils.network.nxos.utils.utils import get_interface_type, normalize_interface
