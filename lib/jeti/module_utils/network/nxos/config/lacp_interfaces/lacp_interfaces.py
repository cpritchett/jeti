...
from jeti.module_utils.network.common.utils import to_list, dict_diff, remove_empties
from jeti.module_utils.network.nxos.facts.facts import Facts
from jeti.module_utils.network.nxos.utils.utils import flatten_dict, search_obj_in_list, get_interface_type, normalize_interface
