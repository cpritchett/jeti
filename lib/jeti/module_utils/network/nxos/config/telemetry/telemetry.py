...
from jeti.module_utils.network.common.cfg.base import ConfigBase
from jeti.module_utils.network.common.utils import to_list
from jeti.module_utils.network.nxos.facts.facts import Facts
from jeti.module_utils.network.nxos.cmdref.telemetry.telemetry import TMS_GLOBAL, TMS_DESTGROUP, TMS_SENSORGROUP, TMS_SUBSCRIPTION
from jeti.module_utils.network.nxos.utils.telemetry.telemetry import normalize_data, remove_duplicate_context
from jeti.module_utils.network.nxos.utils.telemetry.telemetry import valiate_input, get_setval_path, massage_data
from jeti.module_utils.network.nxos.utils.telemetry.telemetry import get_module_params_subsection, remove_duplicate_commands
from jeti.module_utils.network.nxos.utils.utils import normalize_interface
from jeti.module_utils.network.nxos.nxos import NxosCmdRef
