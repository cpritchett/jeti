...
from jeti.module_utils.facts.virtual.base import Virtual, VirtualCollector
from jeti.module_utils.facts.virtual.sysctl import VirtualSysctlDetectionMixin

from jeti.module_utils.facts.utils import get_file_content
