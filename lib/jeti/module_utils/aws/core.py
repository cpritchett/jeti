...
module as shown below.
  ...
  from jeti.module_utils.aws import AnsibleAWSModule
...
from jeti.module_utils.ec2 import HAS_BOTO3, camel_dict_to_snake_dict, ec2_argument_spec, boto3_conn, get_aws_connection_info
...
class AnsibleAWSModule(object):
    ...
    feature is missing please contact the author/jeti AWS team
