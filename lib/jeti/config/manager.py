...
def find_ini_config_file(warnings=None):
    ''' Load INI Config File order(first found is used): ENV, CWD, HOME, /etc/jeti '''
    ...
    # System location
    potential_paths.append("/etc/jeti/jeti.cfg")
    ...
    if path_from_env != path and warn_cmd_public:
        warnings.add(u"Ansible is being run in a world writable directory (%s),"
                     ...
                     u" https://docs.ansible.com/jeti/devel/reference_appendices/config.html#cfg-in-world-writable-dir"
                     % to_text(cwd))
