...
from jeti.module_utils.compat.importlib import import_module
from jeti.module_utils.six import iteritems, string_types, with_metaclass
...
_N_COLLECTION_PATH_RE = re.compile(r'/jeti_collections/([^/]+)/([^/]+)')
