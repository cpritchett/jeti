...
# Discussion: https://github.com/jeti/jeti/pull/50807#discussion_r248827899
RETURN = '''
k8s_auth:
...
from jeti.module_utils.six.moves.urllib_parse import urlparse, parse_qs, urlencode
