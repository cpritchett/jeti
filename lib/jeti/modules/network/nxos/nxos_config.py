...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/nxos_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/nxos_config
date:
...
from jeti.module_utils.network.nxos.nxos import get_config, load_config, run_commands, get_connection
from jeti.module_utils.network.nxos.nxos import nxos_argument_spec
from jeti.module_utils.network.nxos.nxos import check_args as nxos_check_args
