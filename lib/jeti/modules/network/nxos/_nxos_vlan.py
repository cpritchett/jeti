...
from jeti.module_utils.network.nxos.nxos import get_capabilities
from jeti.module_utils.network.nxos.nxos import get_config, load_config, run_commands
from jeti.module_utils.network.nxos.nxos import normalize_interface, nxos_argument_spec
