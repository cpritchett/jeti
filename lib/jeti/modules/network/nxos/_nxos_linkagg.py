...
from jeti.module_utils.network.nxos.nxos import get_capabilities, nxos_argument_spec
from jeti.module_utils.network.nxos.nxos import normalize_interface
