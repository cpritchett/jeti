...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/vsp200_config.2018-08-21@15:00:21
"""
from jeti.module_utils._text import to_text
from jeti.module_utils.connection import ConnectionError
from jeti.module_utils.network.voss.voss import run_commands, get_config
from jeti.module_utils.network.voss.voss import get_defaults_flag, get_connection
from jeti.module_utils.network.voss.voss import get_sublevel_config, VossNetworkConfig
