...
- name: Add a tenant using certificate authentication
  aci_rest:
    ...
    method: post
    path: /api/mo/uni.xml
    src: /home/cisco/jeti/aci/configs/aci_config.xml
...
- name: Configure contracts
  aci_rest:
    ...
    method: post
    path: /api/mo/uni.xml
    src: /home/cisco/jeti/aci/configs/contract_config.xml
  delegate_to: localhost
...
try:
    from jeti.module_utils.six.moves.urllib.parse import parse_qsl, urlencode, urlparse, urlunparse
    HAS_URLPARSE = True
except Exception:
    HAS_URLPARSE = False
...
from jeti.module_utils.network.aci.aci import ACIModule, aci_argument_spec
