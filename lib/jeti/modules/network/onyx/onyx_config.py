...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/onyx_config.2016-07-16@22:28:34
"""

from jeti.module_utils.basic import AnsibleModule
from jeti.module_utils.network.common.config import NetworkConfig, dumps

from jeti.module_utils.network.onyx.onyx import get_config
from jeti.module_utils.network.onyx.onyx import load_config
from jeti.module_utils.network.onyx.onyx import run_commands
