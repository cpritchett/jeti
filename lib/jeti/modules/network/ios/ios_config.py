...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/ios_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/ios_config
date:
...
from jeti.module_utils.network.ios.ios import run_commands, get_config
from jeti.module_utils.network.ios.ios import get_defaults_flag, get_connection
from jeti.module_utils.network.ios.ios import ios_argument_spec
from jeti.module_utils.network.ios.ios import check_args as ios_check_args
