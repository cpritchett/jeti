...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/icx_config.2016-07-16@22:28:34
"""

import json
from jeti.module_utils._text import to_text
from jeti.module_utils.connection import ConnectionError
from jeti.module_utils.network.icx.icx import run_commands, get_config
from jeti.module_utils.network.icx.icx import get_defaults_flag, get_connection
from jeti.module_utils.network.icx.icx import check_args as icx_check_args
