...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/junos01_config
date:
...
from jeti.module_utils.network.junos.junos import get_diff, load_config, get_configuration
from jeti.module_utils.network.junos.junos import commit_configuration, discard_changes, locked_config
from jeti.module_utils.network.junos.junos import junos_argument_spec, load_configuration, tostring
