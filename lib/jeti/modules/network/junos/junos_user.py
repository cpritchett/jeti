...
- name: create new user account
  junos_user:
    name: ansible
    role: super-user
    sshkey: "{{ lookup('file', '~/.ssh/jeti.pub') }}"
    state: present
...
from jeti.module_utils.network.junos.junos import junos_argument_spec, get_connection, tostring
from jeti.module_utils.network.junos.junos import commit_configuration, discard_changes
from jeti.module_utils.network.junos.junos import load_config, locked_config
