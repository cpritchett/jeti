...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/ce_config.2016-07-16@22:28:34
"""
from jeti.module_utils.basic import AnsibleModule
from jeti.module_utils.connection import ConnectionError, Connection
from jeti.module_utils.network.common.config import NetworkConfig as _NetworkConfig
from jeti.module_utils.network.common.config import dumps, ConfigLine, ignore_line
from jeti.module_utils.network.cloudengine.ce import get_config, run_commands, exec_command, cli_err_msg
from jeti.module_utils.network.cloudengine.ce import ce_argument_spec, load_config
from jeti.module_utils.network.cloudengine.ce import check_args as ce_check_args
import re
