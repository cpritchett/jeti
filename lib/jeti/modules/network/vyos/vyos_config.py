...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/vyos_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/vyos_config
date:
...
from jeti.module_utils.network.vyos.vyos import load_config, get_config, run_commands
from jeti.module_utils.network.vyos.vyos import vyos_argument_spec, get_connection
