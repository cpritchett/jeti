...
from jeti.module_utils.network.iosxr.providers.module import NetworkModule
from jeti.module_utils.network.iosxr.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
