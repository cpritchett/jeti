...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/iosxr01_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/iosxr01_config
date:
...
from jeti.module_utils._text import to_text, to_bytes
from jeti.module_utils.basic import AnsibleModule
from jeti.module_utils.connection import ConnectionError
from jeti.module_utils.network.iosxr.iosxr import load_config, get_config, get_connection
from jeti.module_utils.network.iosxr.iosxr import iosxr_argument_spec, copy_file
from jeti.module_utils.network.common.config import NetworkConfig, dumps
...
def run(module, result):
    ...
    if replace_config:
        ...
        if config_diff or running_base_diff_resp['config_diff']:
            ...
            commands = ['load harddisk:/jeti_config.txt']
            replace_file_path = 'harddisk:/jeti_config.txt'
