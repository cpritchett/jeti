...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/ordnance_config.2016-07-16@22:28:34
"""
import re
import time
import traceback

from jeti.module_utils.network.common.network import NetworkModule, NetworkError
from jeti.module_utils.network.common.config import NetworkConfig, dumps
from jeti.module_utils.network.common.parsing import Command
from jeti.module_utils.network.ordnance.ordnance import get_config
