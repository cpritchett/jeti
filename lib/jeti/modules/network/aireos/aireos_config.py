...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/aireos_config.2016-07-16@22:28:34
"""
from jeti.module_utils.network.aireos.aireos import run_commands, get_config, load_config
from jeti.module_utils.network.aireos.aireos import aireos_argument_spec
from jeti.module_utils.network.aireos.aireos import check_args as aireos_check_args
