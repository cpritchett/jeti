...
from jeti.module_utils.network.netconf.netconf import get_capabilities, get_config, get
from jeti.module_utils.network.common.netconf import remove_namespaces
