...
from jeti.module_utils.network.common.utils import is_masklen, validate_ip_address
from jeti.module_utils.network.common.utils import remove_default_spec, validate_prefix
