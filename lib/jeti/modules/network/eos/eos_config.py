...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/eos_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/jeti/backup/eos_config
date:
...
from jeti.module_utils.network.eos.eos import get_config, load_config, get_connection
from jeti.module_utils.network.eos.eos import run_commands
from jeti.module_utils.network.eos.eos import eos_argument_spec
from jeti.module_utils.network.eos.eos import check_args
