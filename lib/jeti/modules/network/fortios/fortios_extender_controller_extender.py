...
from jeti.module_utils.network.fortios.fortios import FortiOSHandler
    ...
    fields = {
        ...
        "extender_controller_extender": {
            ...
            "options": {
                "state": {"required": False, "type": "str",
                          "choices": ["present", "absent"]},
                "aaa_shared_secret": {"required": False, "type": "str", "no_log": True},
                ...
                "ha_shared_secret": {"required": False, "type": "str", "no_log": True},
                ...
                "modem_passwd": {"required": False, "type": "str", "no_log": True},
                ...
                "ppp_echo_request": {"required": False, "type": "str",
                                     "choices": ["enable", "disable"]},
                "ppp_password": {"required": False, "type": "str", "no_log": True},
