...
from jeti.module_utils.network.exos.argspec.lldp_global.lldp_global import Lldp_globalArgs
from jeti.module_utils.network.exos.config.lldp_global.lldp_global import Lldp_global
