...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/x870_config.2018-08-08@15:00:21

"""
import re

from jeti.module_utils.network.exos.exos import run_commands, get_config, load_config, get_diff
