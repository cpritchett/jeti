...
- name: enable rollback location
  sros_config:
    lines: configure system rollback rollback-location "cf3:/jeti"
    provider: "{{ cli }}"
...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/sros_config.2016-07-16@22:28:34
"""
from jeti.module_utils.basic import AnsibleModule
from jeti.module_utils.network.common.config import NetworkConfig, dumps
from jeti.module_utils.network.sros.sros import sros_argument_spec, check_args
from jeti.module_utils.network.sros.sros import load_config, run_commands, get_config
