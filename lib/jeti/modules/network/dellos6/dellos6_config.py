...
backup_path:
  ...
  type: str
  sample: /playbooks/jeti/backup/dellos6_config.2017-07-16@22:28:34
"""
from jeti.module_utils.basic import AnsibleModule
from jeti.module_utils.network.dellos6.dellos6 import get_config, get_sublevel_config, Dellos6NetworkConfig
from jeti.module_utils.network.dellos6.dellos6 import dellos6_argument_spec, check_args
from jeti.module_utils.network.dellos6.dellos6 import load_config, run_commands
from jeti.module_utils.network.dellos6.dellos6 import WARNING_PROMPTS_RE
from jeti.module_utils.network.common.config import dumps
