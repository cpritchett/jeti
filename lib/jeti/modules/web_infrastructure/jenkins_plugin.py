...
from jeti.module_utils.basic import AnsibleModule, to_bytes
from jeti.module_utils.six.moves import http_cookiejar as cookiejar
from jeti.module_utils.six.moves.urllib.parse import urlencode
from jeti.module_utils.urls import fetch_url, url_argument_spec
from jeti.module_utils._text import to_native, text_type, binary_type
import base64
import hashlib
import json
import os
...
def main():
    ...
    # Params was removed
    # https://meetbot.fedoraproject.org/jeti-meeting/2017-09-28/jeti_dev_meeting.2017-09-28-15.00.log.html
