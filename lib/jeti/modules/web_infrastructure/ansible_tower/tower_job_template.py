...
notes:
  - JSON for survey_spec can be found in Tower API Documentation. See
    U(https://docs.ansible.com/jeti-tower/latest/html/towerapi/api_ref.html#/Job_Templates/Job_Templates_job_templates_survey_spec_create)
...
from jeti.module_utils.ansible_tower import TowerModule, tower_auth_config, tower_check_mode
