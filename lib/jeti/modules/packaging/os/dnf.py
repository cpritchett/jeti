...
options:
  ...
  list:
    description:
      - Various (non-idempotent) commands for usage with C(/usr/bin/jeti) and I(not) playbooks. See examples.
...
from jeti.module_utils.six import PY2, text_type
...
class DnfModule(YumDnf):
    ...
    def is_lockfile_pid_valid(self):
        ...
        # https://github.com/jeti/jeti/issues/57189
        return True
    ...
    def fetch_rpm_from_url(self, spec):
        ...
        #   https://github.com/jeti/jeti/pull/19172
