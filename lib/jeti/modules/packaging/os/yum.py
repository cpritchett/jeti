...
notes:
  ...
  - 'The yum module does not support clearing yum cache in an idempotent way, so it
    ...
    https://github.com/jeti/jeti/pull/31450#issuecomment-352889579'
...
from jeti.module_utils.yumdnf import YumDnf, yumdnf_argument_spec
...
from jeti.module_utils.urls import fetch_file
        ...
        if pkgs:
            ...
            for pkg in pkgs:
                ...
                if installed:
                    ...
                    # https://github.com/jeti/jeti/issues/35672
                    ...
                    try:
                        ...
                        for i in new_repos:
                            if i not in current_repos:
                                ...
                                a = rid.repoXML.repoid  # nopep8 - https://github.com/jeti/jeti/pull/21475#pullrequestreview-22404868
