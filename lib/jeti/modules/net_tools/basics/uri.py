...
# https://github.com/jeti/jeti/issues/52705 where a proxy is defined
...
from jeti.module_utils.basic import AnsibleModule, sanitize_keys
from jeti.module_utils.six import PY2, iteritems, string_types
from jeti.module_utils.six.moves.urllib.parse import urlencode, urlsplit
