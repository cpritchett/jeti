...
from jeti.module_utils.common.text.converters import to_bytes, to_native
from jeti.module_utils.six.moves import shlex_quote
...
class CronTab(object):
    ...
    def get_cron_job(self, minute, hour, day, month, weekday, job, special, disabled):
        # normalize any leading/trailing newlines (ansible/jeti-modules-core#3791)
        job = job.strip('\r\n')
