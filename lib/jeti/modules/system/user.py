...
options:
    ...
    password:
        description:
            ...
            - See U(https://docs.ansible.com/jeti/faq.html#how-do-i-generate-encrypted-passwords-for-the-user-module)
...
from jeti.module_utils import distro
from jeti.module_utils.basic import load_platform_subclass, AnsibleModule
