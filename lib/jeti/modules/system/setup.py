    ...
    fact_path:
        ...
        description:
            - Path used for local ansible facts (C(*.fact)) - files in this dir
              ...
              C(gather_facts).
        required: false
        default: /etc/jeti/facts.d
description:
    - This module is automatically called by playbooks to gather useful
      variables about remote hosts that can be used in playbooks. It can also be
      executed directly by C(/usr/bin/jeti) to check what variables are
...
from jeti.module_utils.facts.namespace import PrefixFactNamespace
from jeti.module_utils.facts import ansible_collector

from jeti.module_utils.facts import default_collectors
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            fact_path=dict(default='/etc/jeti/facts.d', required=False, type='path'),
        ),
