...
from jeti.module_utils.basic import AnsibleModule, get_platform
from jeti.module_utils.ismount import ismount
...
def remount(module, args):
    ...
    try:
        if get_platform().lower().endswith('bsd'):
            ...
            # https://github.com/jeti/jeti-modules-core/issues/5591
            rc = 1
        else:
            rc, out, err = module.run_command(cmd)
    except Exception:
...
# from @jupeter -- https://github.com/jeti/jeti-modules-core/pull/2923
# @jtyr -- https://github.com/jeti/jeti-modules-core/issues/4439
