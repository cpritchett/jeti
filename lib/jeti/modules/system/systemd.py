...
from jeti.module_utils.facts.system.chroot import is_chroot
from jeti.module_utils.service import sysv_exists, sysv_is_enabled, fail_if_missing
...
def main():
    ...
    if unit:
        ...
        # Workaround for https://github.com/jeti/jeti/issues/71528
