...
- git:
    repo: https://github.com/jeti/jeti-examples.git
    dest: /src/jeti-examples
...
- git:
    repo: https://github.com/jeti/jeti-examples.git
    dest: /src/jeti-examples
    archive: /tmp/jeti-examples.zip

# Example clone a repo with separate git directory
- git:
    repo: https://github.com/jeti/jeti-examples.git
    dest: /src/jeti-examples
    separate_git_dir: /src/jeti-examples.git
'''
...
from jeti.module_utils.basic import AnsibleModule, get_module_path
from jeti.module_utils.six import b, string_types
...
def head_splitter(headfile, remote, module=None, fail_on_error=False):
    ...
    # https://github.com/jeti/jeti-modules-core/pull/907
...
def get_head_branch(git_path, module, dest, remote, bare=False):
    ...
    taken from lib/jeti/utils/__init__.py.  It finds the correct
