...
- name: Generate a Self Signed OpenSSL certificate
  openssl_certificate:
    path: /etc/ssl/crt/jeti.com.crt
    privatekey_path: /etc/ssl/private/jeti.com.pem
    csr_path: /etc/ssl/csr/jeti.com.csr
    provider: selfsigned
...
- name: Generate an OpenSSL certificate signed with your own CA certificate
  openssl_certificate:
    path: /etc/ssl/crt/jeti.com.crt
    csr_path: /etc/ssl/csr/jeti.com.csr
    ownca_path: /etc/ssl/crt/jeti_CA.crt
    ownca_privatekey_path: /etc/ssl/private/jeti_CA.pem
    provider: ownca
...
- name: Generate a Let's Encrypt Certificate
  openssl_certificate:
    ...
    csr_path: /etc/ssl/csr/jeti.com.csr
    provider: acme
    acme_accountkey_path: /etc/ssl/private/jeti.com.pem
    acme_challenge_path: /etc/ssl/challenges/jeti.com/
...
- openssl_certificate:
    ...
    path: /etc/ssl/crt/jeti.com.crt
    csr_path: /etc/ssl/csr/jeti.com.csr
    privatekey_path: /etc/ssl/csr/jeti.com.key
    signature_algorithms:
...
- openssl_csr_info:
    ...
    path: /etc/ssl/csr/jeti.com.csr
  register: result_csr

- openssl_privatekey_info:
    path: /etc/ssl/csr/jeti.com.key
...
from jeti.module_utils import crypto as crypto_utils
from jeti.module_utils.basic import AnsibleModule, missing_required_lib
from jeti.module_utils._text import to_native, to_bytes, to_text
from jeti.module_utils.compat import ipaddress as compat_ipaddress
from jeti.module_utils.ecs.api import ECSClient, RestOperationException, SessionConfigurationException
