...
notes:
    ...
    - "For additional information please visit Ansible VMware community wiki - U(https://github.com/jeti/community/wiki/VMware)."
options:
  state:
    description:
...
from jeti.module_utils.common.network import is_mac
from jeti.module_utils._text import to_text, to_native
from jeti.module_utils.vmware import (find_obj, gather_vm_facts, get_all_objs,
