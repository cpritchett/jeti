...
from jeti.module_utils.vmware import vmware_argument_spec, PyVmomi, find_datacenter_by_name, wait_for_task, get_all_objs
    ...
    def ensure(self):
        ...
        if state == 'present':
            ...
            try:
                ...
                # https://github.com/jeti/jeti/issues/35388#issuecomment-362283078
