...
from jeti.module_utils.six.moves.urllib.parse import urlencode, quote
from jeti.module_utils._text import to_native
from jeti.module_utils.urls import open_url
from jeti.module_utils.vmware import PyVmomi, vmware_argument_spec, wait_for_task, get_parent_datacenter
import os
