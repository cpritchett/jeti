...
notes:
    ...
    - Return values contain customer_gateway and customer_gateways keys which are identical dicts. You should use
      customer_gateway. See U(https://github.com/jeti/jeti-modules-extras/issues/2773) for details.
options:
  bgp_asn:
    description:
...
from jeti.module_utils.ec2 import (boto3_conn, AWSRetry, camel_dict_to_snake_dict,
