  ...
  policy:
    description:
      - A properly formatted json policy as string, see
        U(https://github.com/jeti/jeti/issues/7005#issuecomment-42894813).
...
from jeti.module_utils.ec2 import (get_aws_connection_info, boto3_conn, ec2_argument_spec, HAS_BOTO3,
