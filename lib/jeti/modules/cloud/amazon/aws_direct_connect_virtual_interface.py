...
from jeti.module_utils.aws.direct_connect import DirectConnectError, delete_virtual_interface
from jeti.module_utils.ec2 import (AWSRetry, HAS_BOTO3, boto3_conn,
