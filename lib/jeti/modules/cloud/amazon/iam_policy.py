  ...
  policy_json:
    description:
      - A properly json formatted policy as string (mutually exclusive with C(policy_document),
        see https://github.com/jeti/jeti/issues/7005#issuecomment-42894813 on how to use it properly)
  state:
    description:
...
from jeti.module_utils.ec2 import connect_to_aws, ec2_argument_spec, get_aws_connection_info, boto_exception
from jeti.module_utils.six import string_types
from jeti.module_utils.six.moves import urllib
