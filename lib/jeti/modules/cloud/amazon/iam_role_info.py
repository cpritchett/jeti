...
iam_roles:
  ...
  contains:
    arn:
      ...
      returned: always
      type: str
      sample: arn:aws:iam::123456789012:role/jetiTestRole
    ...
    managed_policies:
      ...
      contains:
        policy_arn:
          ...
          returned: always
          type: str
          sample: arn:aws:iam::123456789012:policy/jetiTestEC2Policy
        policy_name:
    ...
    instance_profiles:
      ...
      contains:
        arn:
          ...
          returned: always
          type: str
          sample: arn:aws:iam::123456789012:instance-profile/jetiTestEC2Policy
        create_date:
...
from jeti.module_utils.ec2 import boto3_conn, get_aws_connection_info, ec2_argument_spec, AWSRetry
