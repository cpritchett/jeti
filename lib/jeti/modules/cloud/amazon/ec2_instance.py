...
from jeti.module_utils.six import text_type, string_types
from jeti.module_utils.six.moves.urllib import parse as urlparse
...
def tower_callback_script(tower_conf, windows=False, passwd=None):
    script_url = 'https://raw.githubusercontent.com/jeti/jeti/devel/examples/scripts/ConfigureRemotingForAnsible.ps1'
