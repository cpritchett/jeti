...
from jeti.module_utils.parsing.convert_bool import BOOLEANS_FALSE, BOOLEANS_TRUE
from jeti.module_utils.six.moves import xrange
...
class LxcContainerManagement(object):
    ...
    def _config(self):
        ...
        # Issue: https://github.com/jeti/jeti/issues/7679
