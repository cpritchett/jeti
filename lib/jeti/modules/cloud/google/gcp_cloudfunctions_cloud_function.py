...
- name: create a cloud function
  gcp_cloudfunctions_cloud_function:
    ...
    source_archive_url: gs://jeti-cloudfunctions-bucket/function.zip
    trigger_http: 'true'
...
from jeti.module_utils.gcp_utils import navigate_hash, GcpSession, GcpModule, GcpRequest, remove_nones_from_dict, replace_resource_dict
import json
import re
import time
