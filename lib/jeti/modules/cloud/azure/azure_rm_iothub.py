...
from jeti.module_utils.azure_rm_common import AzureRMModuleBase, format_resource_id
from jeti.module_utils.common.dict_transformations import _snake_to_camel, _camel_to_snake
import re
