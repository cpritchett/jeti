...
'''
from jeti.module_utils.azure_rm_common import AzureRMModuleBase, normalize_location_name
from jeti.module_utils.common.dict_transformations import _snake_to_camel
