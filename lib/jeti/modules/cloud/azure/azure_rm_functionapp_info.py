...
azure_functionapps:
    ...
    type: list
    example:
        id: /subscriptions/.../resourceGroups/jeti-rg/providers/Microsoft.Web/sites/myfunctionapp
        name: myfunctionapp
        kind: functionapp
        location: East US
        ...
        server_farm_id: /subscriptions/.../resourceGroups/jeti-rg/providers/Microsoft.Web/serverfarms/EastUSPlan
        reserved: false
...
from jeti.module_utils.azure_rm_common import AzureRMModuleBase
