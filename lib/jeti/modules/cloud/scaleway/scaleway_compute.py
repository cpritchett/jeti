...
from jeti.module_utils.six.moves.urllib.parse import quote as urlquote
from jeti.module_utils.scaleway import SCALEWAY_LOCATION, scaleway_argument_spec, Scaleway
